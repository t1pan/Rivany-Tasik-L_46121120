                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body bg-secondary text-dark bg-opacity-25">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                <input type="text" class="form-control" value="<?= $data["tawarid"]["nomor_penawaran"]; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-6">
                                <input type="text" class="form-control" value="<?= $data["tawarid"]["nama_pelanggan"]; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                <input type="text" class="form-control" value="<?= $data["tawarid"]["alamat"]; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                <input type="date" class="form-control" value="<?= $data["tawarid"]["tgl_penawaran"]; ?>" readonly>
                                </div>
                            </div>
                        </div>
