                            ...
                            <table class="table table-bordered bg-white">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="<?= APLIKASI; ?>/barang/tampil/" button class="btn btn-black btn-sm"> LIHAT </button> </a>
                                        </td>
                                        <td>
                                            <a href="<?= APLIKASI; ?>/barang/edit/" button class="btn btn-warning btn-sm"> EDIT </button> </a>
                                        </td>
                                        <td>
                                            <a href="<?= APLIKASI; ?>/barang/hapus/" button class="btn btn-danger btn-sm"> DELETE </button> </a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
