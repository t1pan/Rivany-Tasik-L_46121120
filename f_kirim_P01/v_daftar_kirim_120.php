                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?= APLIKASI; ?>/kirim/tampil" button class="btn btn-light btn-sm"> LIHAT </button> </a>

                                        </td>

                                        <td class="text-center">

                                            <a href="<?= APLIKASI; ?>/kirim/edit" button class="btn btn-warning btn-sm"> EDIT </button> </a>

                                        </td>
                                        <td class="text-center">

                                            <a href="<?= APLIKASI; ?>/kirim/hapus" button class="btn btn-danger btn-sm"> DELETE </button> </a>
