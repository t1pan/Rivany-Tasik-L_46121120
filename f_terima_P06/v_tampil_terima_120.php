                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body bg-gradient-success text-dark bg-opacity-25">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="kdp" value="<?= $data["terimaid"]["nama_pelanggan"]; ?>"readonly>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <div class="col-3">
                                    <input type="text" class="form-control" value="<?= $data["terimaid"]["tgl_pesanan"]; ?>"readonly>
                                </div>
                            </div>
