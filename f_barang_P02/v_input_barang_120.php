            ...
            <div class="row">
                <div class="card">
                    ...
                    <div class="card-body bg-warning">
                        ...
                        <div class="form-group mb-4">
                            <h6 label for="" style="color:black"><strong>Berat Bersih</strong></label></h6>
                            <input id="berat_bersih" type="text" class="form-control" nama="berat_bersih">
                        </div>

                        <div class="form-group mb-4">
                            <h6 label for="" style="color:black"><strong>Kode Produksi</strong></label></h6>
                            <input id="kode_produksi" type="text" class="form-control" nama="kode_produksi">
                        </div>
                    </div>
