                ...
                <div class="card">
                    <div class="card-header">
                                    ...
                                    <?php foreach ($data['terima'] as $miw=> $isi) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= APLIKASI; ?>/terima/cetak_satu/<?= $isi['id']; ?>" button class="btn btn-danger btn-sm edit" id-edit="<?= $isi['id_master_pengiriman']; ?>"> CETAK </button> </a>
                        ...
                        <div class="card-footer">
                            <a href="<?= APLIKASI; ?>/terima/cetak" button class="btn btn-dark btn-sm"> CETAK </button></a>
