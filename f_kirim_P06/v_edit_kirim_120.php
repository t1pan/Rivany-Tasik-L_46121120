        ...
        <main class="page-content">
            ...
            <div class="row">
                <div class="card">
                    ...
                    <div class="row mt-4">
                        <label for="" class="col-2" style="color:black"> <strong>TANGGALPENGIRIMAN</strong></label>
                        <div class="col-3">
                            <input type="" class="form-control" value="<?= $data["kirim"]["tgl_pengiriimann"]; ?>" name="tglpengiriman">
                        </div> 

                        <label for="" class="col-4" style="color:black" align="right"> <strong>EXPEDISI</strong></label>
                        <div class="col-3">
                            <input type="text" class="form-control" value="<?= $data["kirim"]["expedisi"]; ?>" name="exp">
                        </div>
                    </div>
