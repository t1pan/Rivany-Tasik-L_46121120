                                    ...
                                    <?php foreach ($data['kirim'] as $miw=> $isi) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= APLIKASI; ?>/kirim/edit/<?= $isi['id']; ?>" button class="btn btn-warning btn-sm edit" id-edit="<?= $isi['id_pesanan']; ?>"> EDIT </button> </a>

                                            </td>

                                            <td class="text-center">

                                            <a href="<?= APLIKASI; ?>/kirim/hapus/<?= $isi['id']; ?>" button class="btn btn-warning btn-sm edit" id-delete="<?= $isi['id_pesanan']; ?>"> DELETE </button> </a>

                                            </td>

                                            <td class="text-center">

                                            <a href="<?= APLIKASI; ?>/kirim/cetak_satu/<?= $isi['id']; ?>" button class="btn btn-warning btn-sm edit" id-edit="<?= $isi['id_pesanan']; ?>"> CETAK </button> </a>
