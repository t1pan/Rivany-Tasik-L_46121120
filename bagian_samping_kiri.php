<div class="sidebar-wrapper" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content mm-active" style="padding: 0px;">
			<div class="sidebar-header">
				<div>
					<img src="<?=ASET;?>/images/logo-icon.png" class="logo-icon" alt="logo icon">
				</div>
				<div>
			...
			<ul class="metismenu mm-show" id="menu">
				...
				<li class="mm-active">
					...
					<ul class="mm-show mm-collapse">
						...
						<li class="mm-active"> <a href="error-blank-page.html" target="_blank" aria-expanded="true"><i class="bx bx-right-arrow-alt"></i>Blank Page</a>
						</li>
					</ul>
				</li>
				<li>
			...
			<!--end navigation-->
		</div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 1410px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 232px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></div>